      ...
      >
        ...
        <PageContainer>
          ...
          <MainContainer>
            <ContainerHeader>
              <ContainerTitle>
                {specificGroup.category === "Saude" ? (
                  <FitnessCenterIcon style={{ color: "#802727" }} />
                ) : specificGroup.category === "Alimentação" ? (
                  <FastfoodIcon style={{ color: "#1A237E" }} />
                ) : specificGroup.category === "Estudo" ? (
                  <MenuBookIcon style={{ color: "#275a29" }} />
                ) : (
                ...
                <div>
                  <h1>
                    {specificGroup.name}{" "}
                    <CreateIcon onClick={() => setEditGroup(true)} />
                  </h1>
              ...
              <div className="buttons">
                {enterGroup || register ? (
                  <SubscribeGroupButton disabled>
                    <ControlPointIcon />{" "}
                    {mobileLarge && <span>entrar no grupo</span>}
                  </SubscribeGroupButton>
                ) : (
                  <SubscribeGroupButton
                    onClick={() => {
                ...
                <Button onClick={() => setSpecificGroup("")}>
                  <ArrowBackIcon />
                  {mobileLarge && <span>voltar</span>}
                </Button>
              </div>
            </ContainerHeader>
            ...
            <Container>
              ...
              <ContentContainer>
                <ContainerText>
                  ...
                  <Button onClick={() => setCreateGoal(true)}>
                    <ControlPointIcon />{" "}
                    {mobileLarge && <span>criar objetivo</span>}
                  </Button>
                </ContainerText>
                <CardsContainer>
                  {goals.map((goal) => (
            ...
            <Container>
              ...
              <ContentContainer>
                <ContainerText>
                  ...
                  <Button
                    color="#E65100"
                    onClick={() => setCreateActivities(true)}
                  >
                    <ControlPointIcon />
                ...
                {/* {editActivity && (
                <ModalEditActivity setEditActivity={setEditActivity} activity= />
              )} */}
                {previousActivitiesPage !== null && (
                  <Button
                    onClick={() => setCountActivities(countActivities - 1)}
                  >
                    voltar
                  </Button>
                )}
