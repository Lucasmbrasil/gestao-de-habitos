        ...
        <Main>
            ...
            <TopContainer>
                <div className='content-box'>
                    ...
                    <img className='start-button' src={buttonLandingPage} alt='Começar' onClick={() => history.push('/register')} style={{cursor: 'pointer'}}/> 
                </div>
            ...
            <TopMidContainer>
                <div className='content-box'>
                    <h2><span>inicie pelo</span> simples</h2>
                    <img src={img2} alt='Novos hábitos'/>
                </div>
                <div className='content-box'>
                    <p><strong>motivação</strong> é o que te faz começar, <strong>hábito</strong> é o que te faz continuar.</p>
                    <p>alcance suas metas com o <strong>procrastinare</strong></p>
                </div>
            </TopMidContainer>
            <LastMidContainer>
                <div className='content-box-groups'>
                    <div className='groups'>
                        <h3>crie hábitos para <strong>praticar</strong>, e hábitos para <strong>eliminar</strong></h3>
                        <img src={img31} alt='Grupos'/>
                    </div>
                    <div className='groups'>
                        <h3>encontre grupos, conheça pessoas com o mesmo <strong>objetivo</strong></h3>
                        <img src={img32} alt='Grupos'/>
                    </div>
                    <div className='groups'>
                        <h3><strong>motive-se</strong> a conquistar os objetivos</h3>
